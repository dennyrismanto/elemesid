  ...
  return (
    <>
      <div className="hidden md:block">
        <div className="bg-green-line-100 border rounded-xl mx-10 mt-20 mb-4">
          <div className="flex flex-row justify-evenly items-start py-5">
            <div>
              <img
                className="mb-4"
                ...
                alt="picture"
              />
              <p className="w-[335px] text-sm mb-4">
                {`Jl. Prof. DR. Satrio No.7, RT.3/RW.3, Karet Kuningan, Kecamatan
            Setiabudi, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12950`}
              </p>
              <div className="flex flex-row">
                <div className="flex justify-center items-center bg-green-line w-[40px] h-[40px] rounded-full mr-4">
                  <svg
                    width="18"
                    height="14"
                    viewBox="0 0 18 14"
                ...
                <div className="flex justify-center items-center bg-white w-[40px] h-[40px] rounded-full mr-4">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
            ...
            <div>
              <p className="mb-8 text-lg font-medium">Categories</p>
              <p className="mb-4 text-sm">Cupcake</p>
              <p className="mb-4 text-sm">Pizza</p>
              <p className="mb-4 text-sm">Kebab</p>
              <p className="mb-4 text-sm">Salmon</p>
              <p className="mb-4 text-sm">Dougnut</p>
            </div>
            <div>
              <p className="mb-8 text-lg font-medium">About Us</p>
              <p className="mb-4 text-sm">About Us</p>
              <p className="mb-4 text-sm">FAQ</p>
              <p className="mb-4 text-sm">Report Problem</p>
            </div>
            <div>
              <p className="mb-8 text-lg font-medium">Newstletter</p>
              <p className="mb-4 text-sm">
                Get now free 50% discount for all product on your first order
              </p>
              <div className="mb-4">
                <form className="flex w-[250px] h-[40px]">
                  <input
                    className="rounded-l-lg py-2 px-4 border-t-2 mr-0 border-b-2 border-l-2 text-gray-800 border-black bg-white"
                    placeholder="Your email address"
                  />
                  <button className="px-4 rounded-r-lg bg-green-line  text-white font-bold  uppercase border-green-line border-t border-b border-r">
                    Send
                  </button>
                </form>
              </div>
              <p className="mb-4 text-sm"> elemesid@gmail.com</p>
              <p className="mb-4 text-sm"> 0888 1111 2222 </p>
            </div>
          </div>
        </div>
        <div className="flex justify-center items-center w-full">
          <p className="mb-6 text-sm">© 2021 Elemes id. All rights reserved</p>
        </div>
      </div>
